...
| **Article 14** | Human oversight | Ed25519 cryptographic non-repudiation | [`src/aip_jep/compliance_demo.py`](https://github.com/hjs-spec/eusair-jep-initial-assessment/blob/main/aip_jep/compliance_demo.py) |
