...
| --- | --- | --- | --- |
| **Article 12** | **Record-keeping** | [Physical Temporal Sequencing via UUIDv7] | (https://github.com/hjs-spec/eusair-jep-initial-assessment/blob/main/docs/IMMUTABILITY_PROOF.md) |
